  ...
  coral.loadGeometry(1, 1, 1, 1);
  coral.load();

  crab.setSize(96, 96);
  crab.loadGeometry(1, 1, 1, 1);
  crab.load();

  fish.setSize(402, 418);
  fish.loadGeometry(1, 1, 1, 1);
  fish.load();

  turtle.setSize(278, 278);
  turtle.loadGeometry(1, 1, 1, 1);
  turtle.load();

  shark.setSize(134, 136);
  shark.loadGeometry(1, 1, 1, 1);
  shark.load();

  fullVideo.setSize(1080, 1080);
  fullVideo.loadGeometry(1, 1, 3, 3);
  fullVideo.load();
